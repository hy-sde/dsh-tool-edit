...
import { computeFileHash, InMemorySnapshotStore } from '../src/index.ts'
...
describe('InMemorySnapshotStore', () => {
  ...
  describe('hash collisions', () => {
    // These two texts both hash to `258E` under the ported `computeFileHash`.
    // (The upstream pair was tuned to Bun.hash.xxHash32; the harness port uses
    // a spec-compliant xxHash32, so the colliding pair is regenerated here.)
